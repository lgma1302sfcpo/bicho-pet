...
import { useAdjustFiscalSequence, useFiscalAction, useFiscalOverview, useIssueFiscalDocument, useSaveFiscalConfiguration, useSefazStatus, useVoidFiscalNumber } from "@/hooks/use-fiscal";
