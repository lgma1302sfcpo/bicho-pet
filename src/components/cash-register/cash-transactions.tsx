...
export const paymentLabels: Record<PaymentMethod, string> = {
  ...
  STORE_CREDIT: "Fiado", VOUCHER: "Vale", MIXED: "Pagamento misto"
};
...
export function CashTransactions({ report, canManage }: { report: CashRegisterReport; canManage: boolean }) {
  ...
  return <div className="border-t border-border">
    ...
    <Modal open={selected !== null} onClose={() => { if (!correction.isPending) setSelected(null); }} className="max-w-lg" title={selected?.paymentMethod === "STORE_CREDIT" ? "Receber venda fiada" : "Corrigir forma de pagamento"} description={selected ? `Venda ${selected.code} • atual: ${paymentLabels[selected.paymentMethod]}` : undefined}>
