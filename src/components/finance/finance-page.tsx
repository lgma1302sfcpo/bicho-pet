...
export function FinancePage() {
  ...
  async function submit() {
    ...
    try {
      ...
      setDescription(""); setAmount(""); setNotes(""); setFeedback("Lancamento financeiro salvo com sucesso.");
    } catch (error) { setFeedback(error instanceof Error ? error.message : "Nao foi possivel salvar o lancamento."); }
  }
